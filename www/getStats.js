    ...
    function getStatsLooper() {
        getStatsWrapper(function(results) {
            ...
            if (getStatsResult.audio && getStatsResult.video) {
                ...
                getStatsResult.bandwidth.speedRecv = (getStatsResult.audio.bytesReceived - getStatsResult.bandwidth.helper.audioBytesReceived) + (getStatsResult.video.bytesReceived - getStatsResult.bandwidth.helper.videoBytesReceived);
                getStatsResult.bandwidth.helper.audioBytesReceived = getStatsResult.audio.bytesReceived;
                getStatsResult.bandwidth.helper.videoBytesReceived = getStatsResult.video.bytesReceived;
            }
